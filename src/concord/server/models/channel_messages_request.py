...
class ChannelMessagesRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelMessagesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelMessagesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"messages": obj.get("messages")})
        return _obj
