...
class ChannelRelatedResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelRelatedResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in related_channels (list)
        _items = []
        if self.related_channels:
            for _item in self.related_channels:
                if _item:
                    _items.append(_item.to_dict())
            _dict['related_channels'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelRelatedResponse from a dict"""
        if obj is None:
            return None
