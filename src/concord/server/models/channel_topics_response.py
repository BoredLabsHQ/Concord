...
class ChannelTopicsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["platform_id", "channel_id", "topics"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelTopicsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelTopicsResponse from a dict"""
        if obj is None:
            return None
