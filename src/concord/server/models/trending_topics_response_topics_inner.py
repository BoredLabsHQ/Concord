...
from src.concord.server.models.trending_topics_response_topics_inner_channels_inner import \
    TrendingTopicsResponseTopicsInnerChannelsInner
...
class TrendingTopicsResponseTopicsInner(BaseModel):
    """
    TrendingTopicsResponseTopicsInner
    """

    # noqa: E501
    topic: Optional[StrictStr] = None
    channels: Optional[
        List[TrendingTopicsResponseTopicsInnerChannelsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TrendingTopicsResponseTopicsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TrendingTopicsResponseTopicsInner from a dict"""
        if obj is None:
            return None
